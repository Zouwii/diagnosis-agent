...
<!-- Source: nav-navigation-errors/617002-error_carrier-rotater_abnormal_offset.md -->

# JState 错误码 617002：货架中心偏离

> 文档用途：当 AI Agent 在现场日志中发现 `617002` 时，用本文理解错误含义和所属模块，并根据同期日志选择排查方向。

> Agent 视图：仅保留结论、诊断决策、证据/输出契约和 Playbook。完整原文见 [617002-error_carrier-rotater_abnormal_offset.md](../nav-navigation-errors/617002-error_carrier-rotater_abnormal_offset.md)。
