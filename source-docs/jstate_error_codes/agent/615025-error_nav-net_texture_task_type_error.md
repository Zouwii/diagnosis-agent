...
<!-- Source: nav-navigation-errors/615025-error_nav-net_texture_task_type_error.md -->

# JState 错误码 615025：任务类型错误

> 文档用途：当 AI Agent 在现场日志中发现 `615025` 时，用本文理解错误的注册信息和功能背景。

> Agent 视图：仅保留结论、诊断决策、证据/输出契约和 Playbook。完整原文见 [615025-error_nav-net_texture_task_type_error.md](../nav-navigation-errors/615025-error_nav-net_texture_task_type_error.md)。
